        ...
        Repeater {
            ...
            QQC2.ToolButton {
                ...
                background: Rectangle {
                    topLeftRadius: actionButton.index === 0 ? Units.cornerRadius : 0
                    bottomLeftRadius: actionButton.index === 0 ? Units.cornerRadius : 0
                    topRightRadius: actionButton.index === root.actions.length - 1 ? Units.cornerRadius : 0
                    bottomRightRadius: actionButton.index === root.actions.length - 1 ? Units.cornerRadius : 0
